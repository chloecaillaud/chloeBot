...
async function handleAPIError(interaction, error)
{
	...
	messageSucess ? console.log('\nnotified user of following API error:') : console.warn('\nFailed to notify user of the following error:');
	console.error(error);
}
...
function handleDiscordJsError(interaction, error)
{
	...
	const messageSucess = sendErrorMessage(interaction, errorMessage);
	messageSucess ? console.log('\nnotified user of following DiscordJs error:') : console.warn('\nFailed to notify user of the following error:');
	console.error(error);
}
...
function handleJsError(interaction, error)
{
	...
	const messageSucess = sendErrorMessage(interaction, errorMessage);
	messageSucess ? console.log('\nnotified user of following Js error:') : console.warn('\nFailed to notify user of the following error:');
	console.error(error);
}
